...
export function RecentCases() {
  ...
  const recentCases = getAllCases().slice(0, 6);
  return (
    <div className="rounded-card border border-white/[0.04] bg-card shadow-card">
      ...
      {recentCases.length === 0 ? (
        <div className="px-5 py-12 text-center">
          <p className="text-sm text-muted-foreground mb-2">No cases yet</p>
          <p className="text-xs text-muted-foreground/60">Create your first case to get started</p>
        </div>
      ) : (
